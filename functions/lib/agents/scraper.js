...
exports.scrapeCompanyWebsites = scrapeCompanyWebsites;
exports.scrapePortalWebsites = scrapePortalWebsites;
...
async function callPuppeteer(action, params, sessionId) {
    ...
    try {
        const response = await (0, node_fetch_1.default)(PUPPETEER_SERVICE_URL, {
            method: 'POST',
...
// ==================================================================
async function scrapeSingleUrl(url, sourceType) {
    ...
    try {
        ...
        try {
            ...
            initialContent = await (0, tools_1.webFetch)(url);
        ...
        if (parsedResult.nextUrl) {
            ...
            const secondFetch = await (0, tools_1.webFetch)(nextUrl);
            ...
            responseText = ((_k = (_j = (_h = (_g = (_f = result.response.candidates) === null || _f === void 0 ? void 0 : _f[0]) === null || _g === void 0 ? void 0 : _g.content) === null || _h === void 0 ? void 0 : _h.parts) === null || _j === void 0 ? void 0 : _j[0]) === null || _k === void 0 ? void 0 : _k.text) || '';
            ...
            parsedResult = Object.assign(Object.assign({}, parsedResult), finalParsedResult);
        }
        return {
            sourceUrl: url,
...
async function processInBatches(items, processItem, batchSize, taskId) {
    var _a;
    const results = [];
...
async function scrapeCompanyWebsites(taskId, urls) {
...
async function scrapePortalWebsites(taskId, urls) {
